...
namespace SIPSorcery.Net
{
    ...
    public class RtpIceChannel : RTPChannel
    {
                        ...
                        if (header != null)
                        {
                            ...
                            if (recvRemainingSegment.Count >= stunMsgBytes)
                            {
                                ...
                                CallOnPacketReceivedCallback(
                                    ...
                                    remoteEP,
                                    new ReadOnlySpan<byte>(recvRemainingSegment.Array, recvRemainingSegment.Offset, stunMsgBytes));
        ...
        private bool OnBindingFailure(Exception exception)
        {
        ...
        private SocketError SendTurnCreatePermissionsRequest(string transactionID, IceServer iceServer, IPEndPoint peerEndPoint)
        {
            ...
            var sendResult = iceServer.Protocol == ProtocolType.Tcp ?
                                ...
                                base.Send(RTPChannelSocketsEnum.RTP, iceServer.ServerEndPoint, createPermissionReqBytes, OnBindingFailure);
