...
namespace SIPSorcery.Net
{
    public class SctpDataSender
    {
        ...
        // TODO: Replace the send queue with a blocking queue.
        /// <summary>
        ...
        private void DoSend(object state)
        {
            ...
            {
                // Preserve wakeups fired by SACKs while this loop is sending.
                // Resetting after the send work can erase those signals and force
                // an unnecessary burst-period sleep.
                _senderMre.Reset();
