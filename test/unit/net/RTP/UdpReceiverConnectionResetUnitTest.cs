...
namespace SIPSorcery.Net.UnitTests
{
    ...
    internal class ConnectionResetUdpReceiver : UdpReceiver
    {
        ...
        protected override void EndReceiveFrom(IAsyncResult ar)
        {
            if (_injectReset)
            {
                ...
                EndReceiveFrom(new SocketException((int)SocketError.ConnectionReset));
                RestartReceiveLoop();
                return;
            }
        ...
        protected override void EndReceiveFrom(SocketReceiveFromResult result)
        {
            if (_injectReset)
            {
                _injectReset = false;
    ...
    public class UdpReceiverConnectionResetUnitTest
    {
        ...
        public async Task ReceiveLoopSurvivesConnectionReset()
        {
            ...
            {
                packetReceived.TrySetResult(packet.ToArray());
            };
